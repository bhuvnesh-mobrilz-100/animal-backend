...
export function EventCategoriesCrud() {
  ...
  const confirmDeleteCategory = async () => {
    ...
    try {
      const { error } = await supabase
        .from("event_categories")
        .delete()
        .eq("event_category_id", selectedCategory.event_category_id)

      if (error) throw error
      
      setCategories(categories.filter(c => c.event_category_id !== selectedCategory.event_category_id))
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold">Event Categories Management</h2>
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <ScrollableDialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new event category to organize events.
            </DialogDescription>
          </DialogHeader>
          <EventCategoryForm
            onSuccess={() => {
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <ScrollableDialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Update the event category details.
            </DialogDescription>
          </DialogHeader>
          {selectedCategory && (
            <EventCategoryForm
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the event category. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
